...
int main()
{
    ...
    int arrlengths[] = { 4, 8 };
    cout << "Commonel: " << (commonel(pointers, 2, arrlengths) ? "true" : "false") << endl; // true заради 1

    int arr3[] = { 100, 34, 89, 32, 66 }; // 5 елемента
    int* pointers2[] = { arr1, arr3 };
    int arrlengths2[] = { 4, 5 };
    cout << "Commonel: " << (commonel(pointers2, 2, arrlengths2) ? "true" : "false") << endl; // false понеже няма еднакви елементи в arr и arr3
